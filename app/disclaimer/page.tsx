...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Tasty Travels disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Tasty Travels disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Tasty Travels (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on tastytravels.co
                ...
                <p>
                    Tasty Travels is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Tasty Travels displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Tasty Travels.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Tasty Travels is not responsible for any errors
