...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Tasty Travels puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Tasty Travels categories'],
  alternates: {
