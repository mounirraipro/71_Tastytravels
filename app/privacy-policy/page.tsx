...
export const metadata: Metadata = {
    ...
    description: 'Read the Tasty Travels Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Tasty Travels privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Tasty Travels, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Tasty Travels, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Tasty Travels is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@tastytravels.co</strong>.
                </p>
            </div>
        </>
    );
