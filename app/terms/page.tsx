...
export const metadata: Metadata = {
    ...
    description: 'Read the Tasty Travels Terms of Service. Understand the rules and guidelines for using our free online game.',
    keywords: ['Tasty Travels terms of service', 'terms and conditions', 'usage agreement'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    Welcome to Tasty Travels. By accessing or using our website and game, you agree to be
                    bound by these Terms of Service. Please read them carefully before using our services.
                </p>

                <h2>1. Acceptance of Terms</h2>
                <p>
                    By accessing Tasty Travels at tastytravels.co, you acknowledge that you have read,
                ...
                <p>
                    Tasty Travels provides a free, browser-based game. Tasty Travels is a free, browser-based game experience.
                    The service includes the game itself, educational content, blog articles, and related resources.
                </p>

                <h2>3. User Eligibility</h2>
                <p>
                    Tasty Travels is available to users of all ages. However, users under 13 years of age
                ...
                <p>
                    All content on Tasty Travels — including but not limited to the game design, code, images,
                    text, graphics, logos, and audio — is the intellectual property of Tasty Travels or its
                ...
                <p>
                    ...
                    Tasty Travels for personal, non-commercial purposes only.
                </p>

                <h2>5. Acceptable Use</h2>
                <p>When using Tasty Travels, you agree NOT to:</p>
                <ul>
                ...
                <p>
                    ...
                    grant Tasty Travels a non-exclusive, royalty-free, perpetual license to use, modify,
                    and incorporate that content into our services.
                </p>

                <h2>7. Advertisements</h2>
                <p>
                    Tasty Travels displays advertisements from third-party ad networks, including Google
                ...
                <p>
                    Tasty Travels is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any
                ...
                <p>
                    To the fullest extent permitted by law, Tasty Travels and its operators shall not be
                ...
                <p>
                    We reserve the right to suspend or terminate your access to Tasty Travels at our sole
                ...
                <p>
                    ...
                    <strong>legal@tastytravels.co</strong>.
                </p>
            </div>
        </>
    );
