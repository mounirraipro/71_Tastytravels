...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Tasty Travels uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Tasty Travels cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Tasty Travels uses them, and how you can
                ...
                <p>Tasty Travels uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Tasty Travels.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@tastytravels.co</strong>.
                </p>
            </div>
        </>
    );
