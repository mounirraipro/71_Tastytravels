...
export const metadata: Metadata = {
    ...
    description: 'Tasty Travels is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Tasty Travels accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Tasty Travels accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Tasty Travels is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Tasty Travels presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Tasty Travels. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@tastytravels.co</strong></li>
                </ul>
                <p>
